  ...
  return (
    <section className="min-h-screen bg-black text-white flex justify-center items-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-8 flex justify-center items-center gap-3 whitespace-nowrap">
          
          <span>We Design</span>

          {/* ✅ Animated text – no cut */}
          <span className="relative inline-flex min-w-[24ch] justify-start text-blue-400">
